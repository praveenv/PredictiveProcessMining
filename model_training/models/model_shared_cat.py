...
def _training_model(vec, ac_weights, rl_weights, output_folder, args):
    ...
    print('Build model...')
    print(args)
    # print(vec['prefixes']['activities'])
    # print(vec['next_evt']['activities'])
    # print(vec['prefixes']['activities'].shape[1])
    # print(vec['prefixes']['roles'].shape[1])
    # print(vec['prefixes']['times'].shape[1])

    # print(ac_weights.shape[0])
    # print(ac_weights.shape[1])
    # print(ac_weights)
...
# =============================================================================
    ...
    print(vec['next_evt']['roles'].shape[0])
    print(vec['next_evt']['roles'].shape[1])
    print(vec['next_evt']['roles'])
    print(rl_weights)
    print(rl_weights.shape[0])
    print(rl_weights.shape[1])
